...
{
	glm::mat4 matTranslate1 = glm::translate(glm::mat4(1.0f), glm::vec3(0.0, 0.0f, 120.0));
	glm::mat4 matTranslate2 = glm::translate(glm::mat4(1.0f), glm::vec3(0.0, 0.0f, -80.0));

	glm::mat4 upScaling = glm::scale(glm::mat4(1.0f), glm::vec3(0.7f, 0.7f, 0.7f));
	glm::mat4 downScaling = glm::scale(glm::mat4(1.0f), glm::vec3(1.5f, 1.5f, 1.5f));
	...
	view = glm::lookAt(Obs, PctRef, Vert) * upScaling * matTranslate1;
	glUniformMatrix4fv(viewLocation, 1, GL_FALSE, &view[0][0]);
	...
	view = glm::lookAt(Obs, PctRef, Vert) * downScaling * matTranslate2;
	glUniformMatrix4fv(viewLocation, 1, GL_FALSE, &view[0][0]);
