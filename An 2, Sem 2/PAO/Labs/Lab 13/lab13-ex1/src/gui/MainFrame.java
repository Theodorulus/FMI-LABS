/*
 * Created by JFormDesigner on Tue May 18 18:17:30 EEST 2021
 */

package gui;

import main.model.BankAccount;
import main.model.BankAccountType;
...
public class MainFrame extends JFrame {
    ...
    private void button1ActionPerformed(ActionEvent e) {
        ...
        double balance = Double.valueOf(textField2.getText());
        ...
        JOptionPane.showMessageDialog(this, "The bank account was added.", "Info", JOptionPane.INFORMATION_MESSAGE);
        clearFields();
        displayBankAccounts();
    }
